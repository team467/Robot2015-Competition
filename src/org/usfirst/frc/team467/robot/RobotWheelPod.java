...
public class RobotWheelPod implements WheelPod
{
    private static final Logger LOGGER = Logger.getLogger(RobotWheelPod.class);
 ...
 // Magic number copied from WPI code
    ...
    public RobotWheelPod(int driveMotorID, int steeringMotorID, int steeringSensorID, PID pid, double center, boolean invert)
    {
    ...
    /* (non-Javadoc)
     * @see org.usfirst.frc.team467.robot.WheelPod#drive(double, double)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.usfirst.frc.team467.robot.WheelPod#drive(double)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.usfirst.frc.team467.robot.WheelPod#steer(double)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.usfirst.frc.team467.robot.WheelPod#absoluteSteer(double)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.usfirst.frc.team467.robot.WheelPod#getSteering()
     */
    @Override
