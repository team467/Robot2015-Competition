...
public class CameraServer467 {
  ...
  private static CameraServer467 server;

  public static CameraServer467 getInstance() {
    if (server == null) {
      server = new CameraServer467();
    }
    return server;
  }
